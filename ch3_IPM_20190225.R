...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ ----
# ---- IPM size touch - low crowd: general parameters ----
...
# ---- IPM size touch - low crowd: prepare regression models ----
...
# ---- IPM size touch - low crowd: prepare parameter estimates ----
...
# ---- IPM size touch - low crowd: define kernel components ----
...
# ---- *slow, ~ 2 min* IPM size touch - low crowd: numerical implementation ----
...
# ---- *slow, ~ 34 hrs* IPM size touch - low crowd: lambda CI ----
# from Monocarp Lambda Bootstrap CI.R, IPM book pg. 30
...
# ---- IPM size touch - low crowd: perturbation analysis ----
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ ----
# ---- IPM size touch - high crowd: general parameters ----
...
# ---- IPM size touch - high crowd: prepare regression models ----
...
# ---- IPM size touch - high crowd: prepare parameter estimates ----
...
# ---- IPM size touch - high crowd: define kernel components ----
...
# ---- *slow, ~ 2 min* IPM size touch - high crowd: numerical implementation ----
...
# ---- *slow, ~ 34 hrs* IPM size touch - high crowd: lambda CI ----
# from Monocarp Lambda Bootstrap CI.R, IPM book pg. 30
...
# ---- IPM size touch - high crowd: perturbation analysis ----
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ ----
# ---- IPM size touch - med crowd: general parameters ----
...
# ---- IPM size touch - med crowd: prepare regression models ----
...
# ---- IPM size touch - med crowd: prepare parameter estimates ----
...
# ---- IPM size touch - med crowd: define kernel components ----
...
# ---- *slow, ~ 2 min* IPM size touch - med crowd: numerical implementation ----
...
# ---- *slow, ~ 34 hrs* IPM size touch - med crowd: lambda CI ----
# from Monocarp Lambda Bootstrap CI.R, IPM book pg. 30
...
# ---- IPM size touch - med crowd: perturbation analysis ----
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ ----
# ---- IPM size touch - uniform crowd: general parameters ----
...
# ---- IPM size touch - uniform crowd: prepare regression models ----
...
# ---- IPM size touch - uniform crowd: prepare parameter estimates ----
...
# ---- IPM size touch - uniform crowd: define kernel components ----
...
# ---- *slow, ~ 2 min* IPM size touch - uniform crowd: numerical implementation ----
...
# ---- *slow, ~ 34 hrs* IPM size touch - uniform crowd: lambda CI ----
# from Monocarp Lambda Bootstrap CI.R, IPM book pg. 30
...
# ---- IPM size touch - uniform crowd: perturbation analysis ----
