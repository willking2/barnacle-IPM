...
### implementing the mid-point rule

# m = 100
# L = 0.1 # minimum observed recruit size in field is 0.2 mm operc length
# U = 8.0 # maximum observed size in field is 7.637 mm operc length
