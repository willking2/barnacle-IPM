...
g1 <- G_z1z_simple.demo(zvals, min(zvals), m.par_simple) # small individuals
g2 <- G_z1z_simple.demo(zvals, mean(zvals), m.par_simple) # medium individuals
g3 <- G_z1z_simple.demo(zvals, max(zvals), m.par_simple) # large individuals
...
IPM_simple <- mk_K(500, m.par_simple, 0.1, 10)
